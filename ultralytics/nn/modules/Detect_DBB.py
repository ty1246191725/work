...
class Detect_DBB(nn.Module):
    ...
    def __init__(self, nc=80, ch=()):  # detection layer
        ...
        self.DBB = nn.ModuleList(
            nn.Sequential(DiverseBranchBlock(x, x, 3), DiverseBranchBlock(x, x, 3)) for x in ch)  # DySnakeConv
...
class Segment_DBB(Detect_DBB):
    ...
    def __init__(self, nc=80, nm=32, npr=256, ch=()):
        ...
        self.detect = Detect_DBB.forward
...
if __name__ == "__main__":
    ...
    channel = (64, 128, 256)
    # Model
    mobilenet_v1 = Detect_DBB(nc=80, ch=channel)
